...
{
	struct qcom_pas_data *data = gpdsp1_get_pas_data();
...
{
	return qcom_clock_pas_reset(QCOM_CLKS_GPDSP1);
}

TEE_Result gpdsp1_get_resource_table(struct resource_table *rt,
				     size_t *rt_size)
{
